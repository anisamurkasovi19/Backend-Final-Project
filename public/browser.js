...
document.addEventListener("click", function (event) {
  if (event.target.classList.contains("add_item")) {
    ...
    axios
      .post("/books/create-item", { bookTitle: bookTitle, bookAuthor: bookAuthor, bookPrice: bookPrice, bookCategory: bookCategory})
      .then((res) => {
  ...
  //edit
    ...
    axios
      .post("/books/edit-item", { bookTitle, bookAuthor, bookPrice, bookCategory, id })
      .then((res) => {
...
function genrateBooks() {
  ...
  axios
    .get(`/books/pagination_dashboard?skip=${skip}`)
    .then((res) => {
